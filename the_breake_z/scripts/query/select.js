const query = {
    ...
    FROM (
        ...
        LEFT JOIN POKETMON_PERSONALITY PP ON PL.POKETMON_ID=P.ID
        GROUP BY P.NAME
    ) A
    `,
    ...
    alldata_personality: "SELECT * FROM PERSONALITY",
    ...
    alldata_poketmon_personality: "SELECT * FROM POKETMON_PERSONALITY",
