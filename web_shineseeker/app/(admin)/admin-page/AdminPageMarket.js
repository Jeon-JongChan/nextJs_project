...
export default function Home() {
  ...
  const handleSubmitUser = (e) => {
    ...
    updateDataWithFormInputs(e, apitype, "upload-page", addObject, true, false); // 이미지 파일 없는경우에도 id값 포함해서 보내기 위해 설정
  };
    ...
    <div className="flex w-full">
      <div className={`w-full flex flex-col ${menuName}-form`}>
        ...
        >
          ...
          <FileDragAndDrop css={"mt-2 w-full col-span-3 h-[500px]"} id={`market_img_npc`} type={"image/"} text={savedImage ? null : "Drag Or Click"} image={savedImage} objectFit={"fill"} />
