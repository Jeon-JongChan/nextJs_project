...
export default function Component() {
  ...
  return (
    <>
      <div className="flex flex-col w-full" style={{width: "840px", height: "600px"}}>
        {isSelector ? <Selector changeFunc={() => setIsSelector(!isSelector)} /> : <Result changeFunc={() => setIsSelector(!isSelector)} />}
        <div className="img-patrol-init img-patrol-timeline-bg patrol-timeline flex flex-row w-full" style={{height: "188px"}}></div>
      </div>
    </>
  );
}
