    ...
    <>
      <div className="flex flex-col w-full px-5 py-2">
        <div className="memeter-tab">
          ...
          <pre className="memeter_tab_baseinfo w-[800px] min-h-[150px] text-white">{baseinfo}</pre>
        </div>
        <div className="memeter-tab">
          <h2 className="text-white text-[24px]">상세정보</h2>
          <pre className="memeter_tab_detailinfo w-[800px] min-h-[150px] text-white">{detailinfo}</pre>
        </div>
      </div>
